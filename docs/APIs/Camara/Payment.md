...
The Payment API allows you to charge mobile subscribers for the use of your application or content. It also allows you to charge a user directly based on their consent. Payment services are accessible via RESTful web services.
...
#### URL
```
https://ideabiz.lk/apicall/openapi/payment/{version}/{msisdn}/transactions/amount
```
#### Sample URL for V4
```
https://ideabiz.lk/apicall/openapi/payment/v4/tel:+9477xxxxxxx/transactions/amount
```
OR

```
https://ideabiz.lk/apicall/openapi/payment/v4/9477xxxxxxx/transactions/amount
```
...
**NOTE: Please do not use the "serviceID" parameter if you're using Payment v3.**
<br>
<br>
...
```
{
    "amountTransaction": {
        ...
        "resourceURL": "https://ideabiz.lk/apicall/payment/v2/9477xxxxxxx/transactions/amount/DLG212005-1500564823863"
    }
}
```
## Check Balance
